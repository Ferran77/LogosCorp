...
import { services14 } from "@/data/services";

export default function ServicesSurvey({ variant = "dark" }) {
          ...
          <div className="col-xl-6 col-lg-6">
            <div className="service-content-wrap">
              <div className="section-title">
                <h6 className={textColor}>Levantamiento arquitectónico</h6>
                <h2 className={textColor}>
                Proporciona una representación precisa y detallada del estado actual del inmueble o terreno. 
                </h2>
              </div>
              <p className={textColor}>
               También implica un análisis exhaustivo de todos los elementos existentes de su proyecto. 
              </p>
