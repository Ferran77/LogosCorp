        ...
        <div className="row gx-5 align-items-center">
          <div className="col-xl-4 col-lg-4 mt-4 ml-6">
            <div className="section-title mt-8 ">
              ...
              <h3>4 Razones para usar imágenes 360° en su Proyecto Arquitectónico:</h3>
            </div>
          </div>
          <div className="col-xl-6 col-lg-6">
            <div className="team-desc">
              <p className="text-justify ml-4">
                Incorporar imágenes 360° en su proceso arquitectónico, no solo
                mejora la presentación del proyecto, sino que también optimiza
                su planificación y ejecución. <br /><br />¡Lleve su diseño al siguiente
                nivel con esta tecnología innovadora!
              </p>
            </div>
          </div>
        </div>
