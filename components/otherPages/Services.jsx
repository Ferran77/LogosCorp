          ...
          <div className="col-xl-6 col-lg-6">
            <div className="service-content-wrap">
              <div className="section-title">
                <h6 className="text-white">¿Se ha preguntado cuánto vale su propiedad?</h6>
                <h2 className="text-white">
                Permítanos hacer un estudio detallado y completo
                </h2>
              </div>
              <p>
                En LOGOS-CORP MÉXICO, contamos con un equipo de expertos que combina experiencia y honestidad. Le ofrecemos un servicio donde tendrá la tranquilidad de saber que sus decisiones están basadas en un análisis riguroso y detallado.
              </p>
